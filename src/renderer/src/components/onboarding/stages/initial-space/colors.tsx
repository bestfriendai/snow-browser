  ...
  useEffect(() => {
    const loadSpaceData = async () => {
      ...
      try {
        ...
        if (space) {
          // Set default colors if they don't exist - using red gradient to match Snow Browser theme
          if (!space.bgStartColor) space.bgStartColor = "#E53E3E";
          if (!space.bgEndColor) space.bgEndColor = "#C53030";
