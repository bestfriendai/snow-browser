  ...
  return (
    <>
      ...
      >
        ...
        <p className="text-gray-300 text-xl font-medium">Your Snow Browser is now set up and ready to use.</p>
      </motion.div>
      ...
      <div className="my-8">
        ...
        >
          <Button
            onClick={advance}
            className="remove-app-drag cursor-pointer px-12 py-6 text-lg bg-green-500 hover:bg-green-600 text-white font-semibold rounded-lg shadow-lg transition-all duration-200"
          >
            Finish
          </Button>
        </motion.div>
