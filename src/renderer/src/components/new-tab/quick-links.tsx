      ...
      <div className="flex justify-between items-center mb-2">
        ...
        <div className="flex gap-2">
          <Dialog open={isAddDialogOpen} onOpenChange={handleDialogOpenChange}>
            ...
            <DialogContent className="bg-black text-white w-[90vw] max-w-md border-gray-600">
              <DialogHeader>
                <DialogTitle className="text-white">Add New Quick Link</DialogTitle>
              </DialogHeader>
              <div className="grid gap-4 py-4">
                <div className="grid grid-cols-4 items-center gap-2 sm:gap-4">
                  <Label htmlFor="name" className="text-right text-white text-sm sm:text-base">
                    Name
                  </Label>
                  <Input
                    id="name"
                ...
                <div className="grid grid-cols-4 items-center gap-2 sm:gap-4">
                  <Label htmlFor="url" className="text-right text-white text-sm sm:text-base">
                    URL
                  </Label>
                  <Input
                    id="url"
      ...
      <div className="flex flex-wrap justify-center gap-2 sm:gap-3 md:gap-4 p-2">
        {quickLinks.map((link, index) => (
          ...
          >
            ...
            <a
              href={link.url}
              className="flex flex-col items-center justify-center w-20 bg-black/80 text-white hover:bg-gray-900/90 rounded-lg p-2 no-underline shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-200 border border-gray-600"
            >
