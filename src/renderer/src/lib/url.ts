...
export function transformUrl(url: string): string | null {
  ...
  // Error Page (snow://error)
  if (urlObject && urlObject.protocol === "snow:" && urlObject.hostname === "error") {
  ...
  // New Tab Page (snow://new-tab)
  if (urlObject && urlObject.protocol === "snow:" && urlObject.hostname === "new-tab") {
    return "";
  }

  // PDF Viewer (snow://pdf-viewer)
  if (urlObject && urlObject.protocol === "snow:" && urlObject.hostname === "pdf-viewer") {
