...
const SNOW_INTERNAL_ALLOWED_DOMAINS: AllowedDomains = {
  "main-ui": true,
  "popup-ui": true,
  settings: true,
  omnibox: true,
...
export function registerSnowInternalProtocol(protocol: Protocol) {
